...
namespace aplikasi_hotel
{
    public partial class Form2 : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            // posisi cetak
            graphics.DrawString("Nama: " + label15.Text, font, new SolidBrush(Color.Black), startX, startY + offset);
            graphics.DrawString("Alamat: " + label16.Text, font, new SolidBrush(Color.Black), startX, startY + offset * 2);
            graphics.DrawString("No. Telepon: " + label17.Text, font, new SolidBrush(Color.Black), startX, startY + offset * 3);
            graphics.DrawString("Check In: " + label18.Text, font, new SolidBrush(Color.Black), startX, startY + offset * 4);
            graphics.DrawString("Jenis Kamar: " + comboBox1.Text, font, new SolidBrush(Color.Black), startX, startY + offset * 5);
            graphics.DrawString("Fasilitas: " + textBox4.Text, font, new SolidBrush(Color.Black), startX, startY + offset * 6);
            graphics.DrawString("Lama Inap: " + comboBox2.Text + " Hari", font, new SolidBrush(Color.Black), startX, startY + offset * 7);
            graphics.DrawString("Harga: Rp. " + textBox5.Text, font, new SolidBrush(Color.Black), startX, startY + offset * 8);
            graphics.DrawString("PPN 10%: Rp. " + textBox6.Text, font, new SolidBrush(Color.Black), startX, startY + offset * 9);
            graphics.DrawString("Total Harga: Rp. " + textBox7.Text, font, new SolidBrush(Color.Black), startX, startY + offset * 10);
            graphics.DrawString(" ", font, new SolidBrush(Color.Black), startX, startY + offset * 11);
            graphics.DrawString("Resepsionis", font, new SolidBrush(Color.Black), startX, startY + offset * 12);
            ...
            graphics.DrawString(username, font, new SolidBrush(Color.Black), startX, startY + offset * 16);
        }
